...
int main() {
  ...
  Nodes inputs = Nodes(num_nodes, in_dim, out_dim);
  ...
  GAT gat_2 = GAT(num_nodes, num_heads, out_dim, num_heads * msg_dim);
...
//    return 1;
//  }
//  nodes *features = new nodes(num_nodes, feat_dim, msg_dim);
